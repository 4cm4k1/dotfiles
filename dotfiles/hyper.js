module.exports = {
	...
	config: {
		...
		fontFamily: '"Noto Mono", "Roboto Mono", Menlo, "DejaVu Sans Mono", Consolas, "Lucida Console", monospace',

		// Font family to use for the UI with optional fallbacks
		uiFontFamily: '"Noto Mono", "Roboto Mono", Menlo, "DejaVu Sans Mono", Consolas, "Lucida Console", monospace',
